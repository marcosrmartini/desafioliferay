...
package com.liveray.client.service.service.persistence.impl.constants;
 ...
 * @generated
 */
public class clPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME =
		"com.liveray.client.service.service";

	public static final String ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER =
		"(origin.bundle.symbolic.name=" + BUNDLE_SYMBOLIC_NAME + ")";

	static {
		Bundle bundle = FrameworkUtil.getBundle(clPersistenceConstants.class);
